...
export const IMPORT_LIMITS = {
  PROJECT_FILE_MAX_BYTES: 8 * 1024 * 1024,
  CATALOG_FILE_MAX_BYTES: 4 * 1024 * 1024,
  IOS_PROJECT_FILE_MAX_BYTES: 5 * 1024 * 1024,
  IOS_CATALOG_FILE_MAX_BYTES: 2 * 1024 * 1024,
};

export const CANVAS_LIMITS = {
  RENDER_MAX_PIXELS: 2_600_000,
  MIN_RENDER_SCALE: 0.75,
  IOS_RENDER_MAX_PIXELS: 1_800_000,
  IOS_MIN_RENDER_SCALE: 0.6,
};

export const TESTCARD_EXPORT_LIMITS = {
  MAX_DIMENSION: 40_000,
  MAX_AREA: 300_000_000,
  IOS_MAX_DIMENSION: 12_000,
  IOS_MAX_AREA: 50_000_000,
};
